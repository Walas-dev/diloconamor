...
export const services: Service[] = [
  ...
  { id: 3, title: 'Dulces', description: 'Cajas y mesas de dulces personalizadas para cada evento.', images: ['/img3.png', '/image1.png'], color: 'butter' },
  ...
  { id: 5, title: 'Toppers', description: 'Detalles personalizados que adornan cada creación.', images: ['/img1.png', '/img2.png'], color: 'rose' },
